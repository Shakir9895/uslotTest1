...
// _mock
import { _invoices, _roles, INVOICE_SERVICE_OPTIONS } from 'src/_mock';
// components
...
import InvoiceTableProfileToolbar from './invoice-table-toolbar';
import { label } from 'yet-another-react-lightbox';
import ProfileTableRow from './invoice-table-row';
...
const TABLE_HEAD = [
  { id: 'no', label: 'No' },
  { id: 'batchname', label: 'Batch Name', width: 200 },
  { id: 'startdate', label: 'Start Date', width: 200 },
  { id: 'enddate', label: 'End Date', width: 200 },
  { id: 'noofstudents', label: 'No of Students', width: 200 },
  { id: 'status', label: 'Status', width: 0 },
  { id: '' },
];
...
export default function ProfileOverViewTeachermngmt() {
  ...
  const handleEditRow = useCallback(
    (id: string) => {
      router.push(uslotPath.singleviewbatchdetails(id));
    },
    [router]
  );
