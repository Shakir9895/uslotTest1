...
import CoursemgmtQuizTableRow from './CoursemangmtQuizTableRow';
...
export default function CourseMngmtQuiz() {
          ...
          <CustomBreadcrumbs
            ...
            action={
              <Button
                ...
                href={uslotPath.createnewquestions}
