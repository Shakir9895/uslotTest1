...
import TeacherManagementTableToolbar from '../../teachermanagement/usermgmt-table-toolbar';
import TeacherMangmtTableRow from '../../teachermanagement/user-managment-table-row';
import CourseManagementTableToolbar from './usermgmt-table-toolbar';
import CourseMangmtTableRow from './user-managment-table-row';
import { getAllCoursesAPiCall } from 'src/api/uslot/academics';
...
const TABLE_HEAD = [
  { id: 'no', label: 'No' },
  { id: 'title', label: 'Title', width: 160 },
  { id: 'category', label: 'Category', width: 220 },
  { id: 'grade', label: 'Grade', width: 180 },
...
export default function CourseManagementListView() {
  ...
  const handleEditRow = useCallback(
    (id?: string) => {
      router.push(uslotPath.editcoursemanagement(id));
    },
    [router]
  );
        ...
        <CustomBreadcrumbs
          ...
          action={
            <Button
              ...
              href={uslotPath.newcoursemanagement}
              variant="contained"
