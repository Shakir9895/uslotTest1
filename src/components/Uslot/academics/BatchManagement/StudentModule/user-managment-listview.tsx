...
import BatchMangmtStudentModuleTableRow from './user-managment-table-row';
...
export default function BatchManagementModuleListView() {
              ...
              <Table size={table.dense ? 'small' : 'medium'} sx={{ minWidth: 960 }}>
                ...
                <TableBody>
                  {dataFiltered
                    ...
                    .map((row) => (
                      <BatchMangmtStudentModuleTableRow
                        key={row.id}
                        row={row}
