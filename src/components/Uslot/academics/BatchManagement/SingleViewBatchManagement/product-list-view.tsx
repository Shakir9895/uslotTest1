...
import CoursemgmtModuleTableRow from '../../Coursemanagement/SingleViewCourseManagement/product-table-row';
import BatchmgmtStudentTableRow from './product-table-row';
...
const TABLE_HEAD = [
  ...
  { id: 'studentname', label: 'Student Name', width: 0 },
  { id: 'enrolleddate', label: 'Enrolled Date', width: 0 },
  { id: 'modules', label: 'Modules', width: 0 },
...
export default function BatchMngmtStudent() {
  ...
  const handleEditRow = useCallback(
    (id: string) => {
      router.push(uslotPath.batchmanagementmodule(id)); //
    },
    [router]
  );
