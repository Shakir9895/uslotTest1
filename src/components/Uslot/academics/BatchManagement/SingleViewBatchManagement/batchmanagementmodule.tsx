...
import BatchmgmtModuleTableRow from './batchmangmntmoduletablerow';
...
const TABLE_HEAD = [
    ...
    { id: 'classlink', label: 'Class Link', width: 0 },
...
export default function BatchMngmtModule() {
