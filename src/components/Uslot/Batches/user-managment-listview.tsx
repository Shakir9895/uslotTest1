...
import BatchesMangmtTableRow from './user-managment-table-row';
...
const TABLE_HEAD = [
  ...
  { id: 'capacity', label: 'Capacity', width: 180 },
...
export default function BatchesListView() {
  ...
  const handleEditRow = useCallback(
    (id?: string) => {
      router.push(uslotPath.batchesDetails(id));
    },
    [router]
  );
