...
import UserMgmtReportTableToolbar from './product-table-toolbar';
import ReportProductTableRow from './product-table-row';

// ----------------------------------------------------------------------

const TABLE_HEAD = [
  { id: 'no', label: 'No', width: 0 },
  { id: 'batchname', label: 'Batch Name', width: 0 },
  { id: 'teacher', label: 'Teacher', width: 0 },
  { id: 'date', label: 'Date', width: 0 },
  { id: 'Report', label: 'Report', width: 0 },
  { id: '', width: 0 },
];
...
export default function UserMngmtReport() {
